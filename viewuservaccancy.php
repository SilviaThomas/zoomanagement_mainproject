...
<section class="py-5 bg-gray">
    <div class="container py-5">
        <h2 class="lined mb-4">Vacancies</h2> 
        ...
        <div class="row">
            <div class="col mt-3">
                    ...
                    <?php
                            include 'dbconnection.php';
                            $animal_data_res= mysqli_query($conn,"SELECT * from tbl_vaccancy WHERE vaccancy_status='1'");
                            if($animal_data_res){
                                if(mysqli_num_rows($animal_data_res) > 0){
                                    while($row= mysqli_fetch_array($animal_data_res)){
                                        $vaccancy_position= $row['vaccancy_position'];
                                        $vaccancy_type= $row['vaccancy_type'];
                                        $start_date= $row['start_date'];
                                        $_SESSION['vaccancy_id']=$row['vaccancy_id'];
                                        ...
                                        <div class="border bg-white p-4 mt-3">
                                                <div class="card-body">
                                                    <h5 class="card-title">'.$vaccancy_position.'</h5>
                                                    <p class="card-text">'.$vaccancy_type.'</p>
                                                    <p class="card-text">'.$start_date.'</p>
                                                    <div class="text-right">
                                                    <a class="btn btn-primary" href="vaccancyapply.php">Apply</a>
                                                    
                                                    <a class="btn btn-primary" href="myhistory.php">History</a>
